  ...
  { menuItem: 'Attributes', render: () =>
    <Tab.Pane align='center' attached={false}>
      <div style={{paddingBottom: 75}}>
        ...
        <Modal closeIcon className='modals' style={{marginTop: 50, padding: 0}} trigger={<Button size='big' compact color='facebook'>Attributes Report</Button>}>
    ...
    <Tab.Pane attached={false} textAlign='center'>
      <div style={{paddingBottom: 75}} align='center'>
        ...
        <Grid stackable textAlign='center'>
          <Modal closeIcon className='modals' style={{marginTop: 50, padding: 0}} trigger={<Button size='massive' compact color='facebook'>Family</Button>}>
            <Modal.Header align='center'>
          ...
          <Modal closeIcon className='modals' style={{marginTop: 50, padding: 0}} trigger={<Button size='huge' compact color='facebook'>Rock Climbing</Button>}>
            <Modal.Header align='center'>
          ...
          <Modal closeIcon className='modals' style={{marginTop: 50, padding: 0}} trigger={<Button size='big' compact color='facebook'>Video Games</Button>}>
